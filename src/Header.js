  ...
  return (
    <div className="header">
      ...
      <div className="search_bar">
        <Icons icon={PermIdentityIcon} name="Profile" />
        <Icons icon={FavoriteBorderIcon} name="Wishlist" />
        <Icons icon={LocalMallOutlinedIcon} name="Bag" />
      </div>
    </div>
  );
}
